...
import org.phobos.secure.group061.FullbrightModule;
            ...
            if (clientWorld != null) {
                ...
                while (true) {
                    ...
                    for (int o = 0; o < 16; ++o) {
                        ...
                        this.field_4133.method_4305(o, n, FullbrightModule.iU34vlhxY4HYPuI3t1IG4GLpjalR1rwR() ? Color.WHITE.hashCode() : 0xFF000000 | z << 16 | y << 8 | x);
                    }
                    ++n;
                }
            }
