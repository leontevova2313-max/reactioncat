...
import org.phobos.secure.group020.FireworksModule;
...
extends MixinEntity {
    ...
    private void tickHook1(class_1309 instance, class_243 vel) {
        if (!FireworksModule.lQwdCF7YfRLGBeLoIc86hFOfdwG3nUvL()) {
        ...
        double delta = FireworksModule.shZY8eYlgLMzVWoQwJuBf1i9nGE6iXtV(1.5);
    ...
    private boolean tickHook(class_1309 instance) {
        if (ElytraFlyModule.cfr_renamed_11()) {
            return false;
        }
    ...
    private class_243 getRotation(class_243 original) {
        ...
        if (!RotationsModule.LyhipsDcSND2mt20iy06Gz5RoalgpLk2()) {
            return original;
        }
        SecureClass0700 manager = SecureClass0361.vy0O2dGTVuT28ESAmaFu6j9eAa9DW6EJ().jbJBRBvK3Na5rdi1h4WNK99O8tRtiWJB();
