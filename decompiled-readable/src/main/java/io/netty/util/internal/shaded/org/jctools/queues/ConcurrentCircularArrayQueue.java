...
SupportsIterator {
    ...
    implements Iterator<E> {
        ...
        private E getNext() {
            ...
            E e;
            do {
                if (this.nextIndex < this.pIndex) continue;
                return null;
            } while ((e = UnsafeRefArrayAccess.lvRefElement(this.buffer, offset = UnsafeRefArrayAccess.calcCircularRefElementOffset(this.nextIndex++, this.mask))) == null);
            return e;
        }
    }
}
