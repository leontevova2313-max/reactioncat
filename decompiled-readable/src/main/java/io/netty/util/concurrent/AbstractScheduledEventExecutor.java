...
extends AbstractEventExecutor {
    ...
    PriorityQueue<ScheduledFutureTask<?>> scheduledTaskQueue() {
        if (this.scheduledTaskQueue == null) {
            this.scheduledTaskQueue = new DefaultPriorityQueue<ScheduledFutureTask<?>>(SCHEDULED_FUTURE_TASK_COMPARATOR, 11);
        }
    ...
    protected void cancelScheduledTasks() {
        ...
        ScheduledFutureTask[] scheduledFutureTaskArray = scheduledTasks = scheduledTaskQueue.toArray(new ScheduledFutureTask[0]);
        ...
        while (true) {
            ...
            ScheduledFutureTask task = scheduledFutureTaskArray[n2];
    ...
    public ScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
        ...
        return this.schedule(new ScheduledFutureTask<V>(this, command, AbstractScheduledEventExecutor.deadlineNanos(this.getCurrentTimeNanos(), unit.toNanos(delay))));
    }
    ...
    public ScheduledFuture<?> scheduleAtFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
        ...
        return this.schedule(new ScheduledFutureTask<V>(this, command, AbstractScheduledEventExecutor.deadlineNanos(this.getCurrentTimeNanos(), unit.toNanos(initialDelay)), unit.toNanos(period)));
    }
    ...
    public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
        ...
        this.validateScheduled0(initialDelay, unit);
        this.validateScheduled0(delay, unit);
        return this.schedule(new ScheduledFutureTask<V>(this, command, AbstractScheduledEventExecutor.deadlineNanos(this.getCurrentTimeNanos(), unit.toNanos(initialDelay)), -unit.toNanos(delay)));
    }
