...
implements ChunkedInput<HttpContent> {
    ...
    public HttpRequest finalizeRequest() throws ErrorDataEncoderException {
        block12: {
                ...
                block11: {
                    ...
                    if (contentTypes != null) {
                        ...
                        for (String contentType : contentTypes) {
                            ...
                            if (((String)lowercased).startsWith(HttpHeaderValues.MULTIPART_FORM_DATA.toString()) || ((String)lowercased).startsWith(HttpHeaderValues.APPLICATION_X_WWW_FORM_URLENCODED.toString())) continue;
                    ...
                    if (realSize <= 8096L && !this.isMultipart) break block11;
                    this.isChunked = true;
                    if (transferEncoding == null) break block12;
                    headers.remove(HttpHeaderNames.TRANSFER_ENCODING);
                    lowercased = transferEncoding.iterator();
                    break block13;
                }
            ...
            while (lowercased.hasNext()) {
                CharSequence v = (CharSequence)lowercased.next();
