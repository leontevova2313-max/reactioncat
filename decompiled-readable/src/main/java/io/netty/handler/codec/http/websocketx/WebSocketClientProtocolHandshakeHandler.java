        ...
        this.handshaker.handshake(ctx.channel()).addListener(new ChannelFutureListener(){
            ...
            public void operationComplete(ChannelFuture future) throws Exception {
                if (!future.isSuccess()) {
                    ...
                    ctx.fireUserEventTriggered((Object)((Object)WebSocketClientProtocolHandler.ClientHandshakeStateEvent.HANDSHAKE_ISSUED));
                }
            }
        });
            ...
            final ScheduledFuture<?> timeoutFuture = this.ctx.executor().schedule(new Runnable(){
                ...
                public void run() {
                    ...
                    if (localHandshakePromise.tryFailure(new WebSocketClientHandshakeException("handshake timed out"))) {
                        WebSocketClientProtocolHandshakeHandler.this.ctx.flush().fireUserEventTriggered((Object)((Object)WebSocketClientProtocolHandler.ClientHandshakeStateEvent.HANDSHAKE_TIMEOUT)).close();
                    }
                }
