...
public final class OpenSsl {
    ...
    static String checkTls13Ciphers(InternalLogger logger, String ciphers) {
        if (IS_BORINGSSL && !ciphers.isEmpty()) {
            ...
            HashSet<E> boringsslTlsv13Ciphers = new HashSet<E>(EXTRA_SUPPORTED_TLS_1_3_CIPHERS.length);
    ...
    private static Set<String> protocols(String property) {
        ...
        String[] stringArray = protocolsString.split(",");
    ...
    static String[] defaultProtocols(boolean isClient) {
        ...
        Iterator<E> iterator = defaultProtocols.iterator();
        while (iterator.hasNext()) {
            String proto = (String)iterator.next();
