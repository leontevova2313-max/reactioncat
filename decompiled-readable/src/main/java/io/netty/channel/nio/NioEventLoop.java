...
extends SingleThreadEventLoop {
        ...
        return new Iterator<Channel>(){
            ...
            private Channel nextOrDone() {
                ...
                do {
                    ...
                    this.isDone = true;
                    return null;
                } while (!(key = it.next()).isValid() || !((attachment = key.attachment()) instanceof AbstractNioChannel));
    ...
    protected void run() {
         ...
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [15[SWITCH], 44[UNCONDITIONALDOLOOP], 17[CASE]], but top level block is 3[TRYBLOCK]
