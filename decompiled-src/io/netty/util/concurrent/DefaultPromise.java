    ...
    private synchronized Object progressiveListeners() {
        ...
        if (listeners != null) {
            ...
            switch (progressiveSize) {
                ...
                case 1: {
                    GenericFutureListener<? extends Future<?>>[] genericFutureListenerArray = dfl.listeners();
                    int n = genericFutureListenerArray.length;
                    int n2 = 0;
                    while (n2 < n) {
                        GenericFutureListener<Future<?>> l = genericFutureListenerArray[n2];
