...
public abstract class Recycler<T> {
    ...
    private final FastThreadLocal<LocalPool<T>> threadLocal = new FastThreadLocal<LocalPool<T>>(){
        ...
        protected LocalPool<T> initialValue() {
            return new LocalPool<T>(Recycler.this.maxCapacityPerThread, Recycler.this.interval, Recycler.this.chunkSize);
        }

        @Override
        protected void onRemoval(LocalPool<T> value) throws Exception {
            super.onRemoval(value);
            MessagePassingQueue handles = ((LocalPool)value).pooledHandles;
    ...
    implements MessagePassingQueue.Consumer<DefaultHandle<T>> {
        ...
        LocalPool(int maxCapacity, int ratioInterval, int chunkSize) {
            ...
            this.batch = new ArrayDeque<E>(chunkSize);
