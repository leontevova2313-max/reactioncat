...
public abstract class WebSocketServerHandshaker {
    ...
    public final ChannelFuture handshake(Channel channel, FullHttpRequest req, HttpHeaders responseHeaders, final ChannelPromise promise) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("{} WebSocket version {} server handshake", (Object)channel, (Object)((Object)this.version()));
        }
    ...
    protected String selectSubprotocol(String requestedSubprotocols) {
        ...
        String[] stringArray = requestedSubprotocolArray = requestedSubprotocols.split(",");
