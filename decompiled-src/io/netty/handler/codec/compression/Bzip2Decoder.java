...
extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        block15: while (true) {
            switch (_1.$SwitchMap$io$netty$handler$codec$compression$Bzip2Decoder$State[this.currentState.ordinal()]) {
                case 1: {
                ...
                case 8: {
                    ...
                    block20: for (currGroup = huffmanStageDecoder.currentGroup; currGroup < totalTables; ++currGroup) {
                        if (reader.hasReadableBits(5)) ** GOTO lbl112
...
lbl115:
                        ...
                        while (true) {
                            if (currAlpha >= alphaSize) ** GOTO lbl120
                            if (reader.isReadable()) ** GOTO lbl128
                            saveStateAndReturn = true;
                            ** GOTO lbl141
lbl120:
                            // 1 sources
