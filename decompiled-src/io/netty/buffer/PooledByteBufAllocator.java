...
implements ByteBufAllocatorMetricProvider {
    ...
    public PooledByteBufAllocator(boolean preferDirect, int nHeapArena, int nDirectArena, int pageSize, int maxOrder, int smallCacheSize, int normalCacheSize, boolean useCacheForAllThreads, int directMemoryCacheAlignment) {
        ...
        if (nDirectArena > 0) {
            ...
            metrics = new ArrayList<E>(this.directArenas.length);
    ...
    public int numThreadLocalCaches() {
        ...
        int total = 0;
        PoolArena<Object>[] poolArenaArray2 = arenas;
        int n = poolArenaArray2.length;
        int n2 = 0;
        while (n2 < n) {
            PoolArena<Object> arena = poolArenaArray2[n2];
    ...
    private static long usedMemory(PoolArena<?>[] arenas) {
        ...
        long used = 0L;
        PoolArena<?>[] poolArenaArray = arenas;
        int n = poolArenaArray.length;
        int n2 = 0;
        while (n2 < n) {
            PoolArena<?> arena = poolArenaArray[n2];
    ...
    private static long pinnedMemory(PoolArena<?>[] arenas) {
        ...
        while (n2 < n) {
            PoolArena<?> arena = poolArenaArray[n2];
            if ((used += arena.numPinnedBytes()) < 0L) {
                return Long.MAX_VALUE;
            }
            ++n2;
        }
