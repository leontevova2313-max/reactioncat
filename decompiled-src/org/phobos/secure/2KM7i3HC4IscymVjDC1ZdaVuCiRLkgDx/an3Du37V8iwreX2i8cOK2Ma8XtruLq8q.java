...
public final class an3Du37V8iwreX2i8cOK2Ma8XtruLq8q {
    public static /* bridge */ /* synthetic */ double cfr_renamed_125(class_243 class_2432, class_243 IYvxXxnixoZAgQ5IQeX7njsD3XoPl0ae) {
        return an3Du37V8iwreX2i8cOK2Ma8XtruLq8q.rLpN2aoFzpuXRg8hu83HAVh8zmAqvhav(class_2432, IYvxXxnixoZAgQ5IQeX7njsD3XoPl0ae) * 20.0;
    }
    ...
    public static /* bridge */ /* synthetic */ List<class_243> AnXXykhXy91g0cpHK9Dwj3FyHJwiCdBp(List<class_243> tyiD6fF6Nxs4e1crNdOLx1IaCG28axUw) {
        ...
        int HbgY1qnA2m6MbAmf1Nd8fqxodZA9lC36 = 0;
        while (HbgY1qnA2m6MbAmf1Nd8fqxodZA9lC36 < tyiD6fF6Nxs4e1crNdOLx1IaCG28axUw.size() - 1) {
            arrayList.add(tyiD6fF6Nxs4e1crNdOLx1IaCG28axUw.get(HbgY1qnA2m6MbAmf1Nd8fqxodZA9lC36 + 1).method_1020(tyiD6fF6Nxs4e1crNdOLx1IaCG28axUw.get(HbgY1qnA2m6MbAmf1Nd8fqxodZA9lC36)));
            ++HbgY1qnA2m6MbAmf1Nd8fqxodZA9lC36;
        }
        return arrayList;
    }
    ...
    public static /* bridge */ /* synthetic */ double cfr_renamed_126(float h9JTLrAEK89za86pNcj7MY2hs3SX7mEk, float nUPGUyIz7JgRJhO0vwEvKRZbTRnk5nmy, float Q2asJs0wt3bde3pXWPRNTgMVn5vpHeGD) {
        ...
        float pPxpjSeWc2ehLK3fWiNavxzLJ3V7BtjS = 1.0f;
        if (h9JTLrAEK89za86pNcj7MY2hs3SX7mEk < 0.0f) {
            pPxpjSeWc2ehLK3fWiNavxzLJ3V7BtjS = -0.5f;
        } else if (h9JTLrAEK89za86pNcj7MY2hs3SX7mEk > 0.0f) {
            pPxpjSeWc2ehLK3fWiNavxzLJ3V7BtjS = 0.5f;
        }
        if (nUPGUyIz7JgRJhO0vwEvKRZbTRnk5nmy > 0.0f) {
            Q2asJs0wt3bde3pXWPRNTgMVn5vpHeGD -= 70.0f * pPxpjSeWc2ehLK3fWiNavxzLJ3V7BtjS;
        }
        if (nUPGUyIz7JgRJhO0vwEvKRZbTRnk5nmy < 0.0f) {
            Q2asJs0wt3bde3pXWPRNTgMVn5vpHeGD += 70.0f * pPxpjSeWc2ehLK3fWiNavxzLJ3V7BtjS;
        }
    ...
    public /* synthetic */ an3Du37V8iwreX2i8cOK2Ma8XtruLq8q() {
    ...
    public static /* bridge */ /* synthetic */ double biQks4q8E5TEPsoWqxda4nG3F5cNfJZk(double qsFq0TmXbNTOKq3u4EebyUMxdPLf9DzF, int lV0Ygn0G00VBjBus4RPKRIfcl51WkGLi) {
        if (lV0Ygn0G00VBjBus4RPKRIfcl51WkGLi == 0) {
            return qsFq0TmXbNTOKq3u4EebyUMxdPLf9DzF;
        }
        double EQL55tk8dcvkVsjufJoYpuOkCl9OytVT = qsFq0TmXbNTOKq3u4EebyUMxdPLf9DzF;
        int Z6ISc0F2YEcy5d7QSBptOwAWc3wwEObs = 0;
        while (Z6ISc0F2YEcy5d7QSBptOwAWc3wwEObs < lV0Ygn0G00VBjBus4RPKRIfcl51WkGLi) {
            EQL55tk8dcvkVsjufJoYpuOkCl9OytVT = (EQL55tk8dcvkVsjufJoYpuOkCl9OytVT - 0.08) * (double)0.98f;
            ++Z6ISc0F2YEcy5d7QSBptOwAWc3wwEObs;
        }
        return EQL55tk8dcvkVsjufJoYpuOkCl9OytVT;
    }
    ...
    public static /* bridge */ /* synthetic */ double pksffTeD5kqWVNWkFibJst0jjoQmjbng(class_1657 hsu7pnbyyKmCKNZPBNHM95lu1lirB4n2) {
        class_243 sGBMGbUQOqtNaywIKq3n4GV5q5k6YGAN = hsu7pnbyyKmCKNZPBNHM95lu1lirB4n2.method_18798();
        return Math.hypot(sGBMGbUQOqtNaywIKq3n4GV5q5k6YGAN.field_1352, sGBMGbUQOqtNaywIKq3n4GV5q5k6YGAN.field_1350);
    }

    public static /* bridge */ /* synthetic */ double al44ITGaE057UFoBFkBJmh8G5CMVodNf(class_742 LoYQZInj2KXvz1t4yZilOg7Dy9EEFiLt) {
        try {
            int jfiRV1uufJxAv0b9fec7O0wbzuYpo5dM = Objects.requireNonNull((class_1293)LoYQZInj2KXvz1t4yZilOg7Dy9EEFiLt.method_6088().get(class_1294.field_5913)).method_5578() + 1;
            return 0.04837 * (double)jfiRV1uufJxAv0b9fec7O0wbzuYpo5dM + 0.5356 * (double)jfiRV1uufJxAv0b9fec7O0wbzuYpo5dM + 1.252;
        }
    ...
    public static /* bridge */ /* synthetic */ double rLpN2aoFzpuXRg8hu83HAVh8zmAqvhav(class_243 JyrEWQyrVptuUnsYyWwaHWgj0kURhFRb, class_243 Oxypcrwie4SgVWTsVCc0Vx5rUtHxk7UA) {
        return an3Du37V8iwreX2i8cOK2Ma8XtruLq8q.X0tf2AZ3tQ0z4kX5CsWCTwEzXePeDL2v(Oxypcrwie4SgVWTsVCc0Vx5rUtHxk7UA).method_1022(an3Du37V8iwreX2i8cOK2Ma8XtruLq8q.X0tf2AZ3tQ0z4kX5CsWCTwEzXePeDL2v(JyrEWQyrVptuUnsYyWwaHWgj0kURhFRb));
    }
}
